...
public class PDateChooser extends JPanel implements ActionListener,
		DocumentListener {
	...
	public PDateChooser(String value) {
		...
		textField.getDocument()
				.addDocumentListener(this); // for text validation
		...
		popupButton.setColors(BUTTON_IDLE_COLOR, BUTTON_OVER_COLOR,
				BUTTON_DOWN_COLOR);
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == popupButton) {
			// show popup
			popup.show(popupButton, popupButton.getPreferredSize().width
			...
			if (e.getActionCommand()
					.equals("+") && monthSpinner.getIndex() == 0)
				yearSpinner.increment();
			else if (e.getActionCommand()
					.equals("-") && monthSpinner.getIndex() == 11)
