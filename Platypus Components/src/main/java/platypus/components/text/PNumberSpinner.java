...
public class PNumberSpinner extends JPanel {
	...
	public PNumberSpinner(int value, int inc) {
		...
		GridBagConstraints fieldConstraints = new GridBagConstraints(0, 0, 1,
				2, .5, 0,
		...
		upButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				numberField.setText(Integer.toString(Integer.parseInt(numberField.getText())
						+ increment));
			}
		});
		GridBagConstraints upConstraints = new GridBagConstraints(1, 0, 1, 1,
				0, 0.5,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(
						0, 0, 0, 0), 5, 0);
		...
		GridBagConstraints downConstraints = new GridBagConstraints(1, 1, 1, 1,
				0, 0.5,
				GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(
						0, 0, 0, 0), 5, 0);
